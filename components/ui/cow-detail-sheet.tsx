...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 right-[375px] z-50",
        "data-[state=open]:fade-in-0 data-[state=open]:animate-cow-details-overlay-in",
        "data-[state=closed]:fade-out-0 data-[state=closed]:animate-cow-details-overlay-out",
