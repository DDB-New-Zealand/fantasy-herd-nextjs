...
// ... (Insert the combined GLSL Fragment Shader from the section above) ...
...
function initWebGL(canvas: HTMLCanvasElement, image: HTMLImageElement) {
...
export const useFieldImageFilterValues = () => {
